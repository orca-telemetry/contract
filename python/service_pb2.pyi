...
class ExecuteAlgorithm(_message.Message):
    __slots__ = ("algorithm", "dependencies", "selfResults")
    ALGORITHM_FIELD_NUMBER: _ClassVar[int]
    DEPENDENCIES_FIELD_NUMBER: _ClassVar[int]
    SELFRESULTS_FIELD_NUMBER: _ClassVar[int]
    algorithm: Algorithm
    dependencies: _containers.RepeatedCompositeFieldContainer[AlgorithmDependencyResult]
    selfResults: _containers.RepeatedCompositeFieldContainer[AlgorithmDependencyResultRow]
    def __init__(self, algorithm: _Optional[_Union[Algorithm, _Mapping]] = ..., dependencies: _Optional[_Iterable[_Union[AlgorithmDependencyResult, _Mapping]]] = ..., selfResults: _Optional[_Iterable[_Union[AlgorithmDependencyResultRow, _Mapping]]] = ...) -> None: ...
