...
export const ExposeSettings: MessageFns<ExposeSettings> = {
  ...
  fromJSON(object: any): ExposeSettings {
    return {
      excludeProject: isSet(object.excludeProject)
        ? globalThis.String(object.excludeProject)
        : isSet(object.exclude_project)
        ? globalThis.String(object.exclude_project)
        : "",
    };
  },
...
export const Window: MessageFns<Window> = {
  ...
  fromJSON(object: any): Window {
    return {
      timeFrom: isSet(object.timeFrom)
        ? fromJsonTimestamp(object.timeFrom)
        : isSet(object.time_from)
        ? fromJsonTimestamp(object.time_from)
        : undefined,
      timeTo: isSet(object.timeTo)
        ? fromJsonTimestamp(object.timeTo)
        : isSet(object.time_to)
        ? fromJsonTimestamp(object.time_to)
        : undefined,
      windowTypeName: isSet(object.windowTypeName)
        ? globalThis.String(object.windowTypeName)
        : isSet(object.window_type_name)
        ? globalThis.String(object.window_type_name)
        : "",
      windowTypeVersion: isSet(object.windowTypeVersion)
        ? globalThis.String(object.windowTypeVersion)
        : isSet(object.window_type_version)
        ? globalThis.String(object.window_type_version)
        : "",
  ...
  fromJSON(object: any): AlgorithmDependency {
    return {
      ...
      processorName: isSet(object.processorName)
        ...
        : "",
      processorRuntime: isSet(object.processorRuntime)
        ? globalThis.String(object.processorRuntime)
        : isSet(object.processor_runtime)
        ? globalThis.String(object.processor_runtime)
        : "",
  ...
  fromJSON(object: any): Algorithm {
    return {
      ...
      windowType: isSet(object.windowType)
        ? WindowType.fromJSON(object.windowType)
        : isSet(object.window_type)
        ? WindowType.fromJSON(object.window_type)
        : undefined,
  ...
  fromJSON(object: any): Result {
    return {
      ...
      resultData: isSet(object.singleValue)
        ...
        : isSet(object.single_value)
        ? { $case: "singleValue", value: globalThis.Number(object.single_value) }
        : isSet(object.floatValues)
        ? { $case: "floatValues", value: FloatArray.fromJSON(object.floatValues) }
        : isSet(object.float_values)
        ? { $case: "floatValues", value: FloatArray.fromJSON(object.float_values) }
...
export const ProcessorRegistration: MessageFns<ProcessorRegistration> = {
  ...
  fromJSON(object: any): ProcessorRegistration {
    return {
      ...
      connectionStr: isSet(object.connectionStr)
        ? globalThis.String(object.connectionStr)
        : isSet(object.connection_str)
        ? globalThis.String(object.connection_str)
        : "",
      supportedAlgorithms: globalThis.Array.isArray(object?.supportedAlgorithms)
        ...
        : globalThis.Array.isArray(object?.supported_algorithms)
        ? object.supported_algorithms.map((e: any) => Algorithm.fromJSON(e))
        : [],
  ...
  fromJSON(object: any): ExecutionRequest {
    return {
      ...
      algorithmResults: globalThis.Array.isArray(object?.algorithmResults)
        ...
        : globalThis.Array.isArray(object?.algorithm_results)
        ? object.algorithm_results.map((e: any) => AlgorithmResult.fromJSON(e))
        : [],
      ...
      algorithmExecutions: globalThis.Array.isArray(object?.algorithmExecutions)
        ...
        : globalThis.Array.isArray(object?.algorithm_executions)
        ? object.algorithm_executions.map((e: any) => ExecuteAlgorithm.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): ExecutionResult {
    return {
      execId: isSet(object.execId)
        ...
        ? globalThis.String(object.exec_id)
        : "",
      algorithmResult: isSet(object.algorithmResult)
        ? AlgorithmResult.fromJSON(object.algorithmResult)
        : isSet(object.algorithm_result)
        ? AlgorithmResult.fromJSON(object.algorithm_result)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): ProcessorMetrics {
    return {
      ...
      memoryBytes: isSet(object.memoryBytes)
        ? globalThis.String(object.memoryBytes)
        : isSet(object.memory_bytes)
        ? globalThis.String(object.memory_bytes)
        : "0",
...
export const OrcaCoreService = {
  ...
  registerProcessor: {
    path: "/OrcaCore/RegisterProcessor" as const,
  ...
  emitWindow: {
    path: "/OrcaCore/EmitWindow" as const,
    requestStream: false as const,
    responseStream: false as const,
...
export const OrcaProcessorService = {
   ...
   */
  executeDagPart: {
    path: "/OrcaProcessor/ExecuteDagPart" as const,
    requestStream: false as const,
  ...
  healthCheck: {
    path: "/OrcaProcessor/HealthCheck" as const,
    requestStream: false as const,
    responseStream: false as const,
